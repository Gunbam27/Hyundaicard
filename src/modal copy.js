...
let summary = document.querySelector('#header span');
let desc = document.querySelector('#header p');
...
var deck = {
  green: {
    ...
    요약: 'My First Luxury',
    설명: '자유와 모험을 즐기는, 나의 첫 럭셔리 카드 국내외 여행·해외쇼핑 5% 적립',
  },
  red: {
  ...
  purple: {
    타이틀: 'the Purple osée',
    요약: 'Not Just Luxury',
    설명: '취향따라 설계·사용하는 바우처 네트워크 항공마일리지와 M포인트 중 선택 적립 <br>기본 적립 혜택에 추가로 제공되는 로열티 보너스',
  },
  fam: {
    타이틀: '현대카드Z family',
    요약: '패밀리용 구간반복 할인카드',
  ...
  naver: {
    ...
    설명: '네이버플러스 멤버십 무료 이용권 제공 네이버플러스 멤버십 적립 대상 결제 시, 네이버페이 포인트 최대 5% 적립 그 외 가맹점 네이버페이 포인트 1% 적립',
  },
  black: {
    타이틀: '혜택의 블랙 라벨',
    요약: '현대카드 MX Black',
